...
import { Policy } from "../../domain/policy/policy.entity.js";
import { PolicyNotFoundError } from "../../domain/policy/policy.errors.js";
...
// Exported for reuse by neo4j-coverage-review.repository.ts, which reads
// the same COVERAGE edge shape from the opposite traversal direction
// (obligation -> policies instead of policy -> obligations).
...
const POLICY_RETURN = `
  ...
  p.department AS department, p.policy_number AS policyNumber,
